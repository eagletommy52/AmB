...
function Story (props) {
  ...
  <div className="storyContainer">
      <div className='story'>
      <img src={'../../images/story/phones.jpg'} alt="Phones Buzzing" />
        <pre>
        ...
        <img src={'../../images/story/westpoint.svg'} alt="Robot Competition"  style={{width: '25rem'}} />
      </div>
  </div>
  )
}
